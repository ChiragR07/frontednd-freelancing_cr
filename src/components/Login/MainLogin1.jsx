...
export default function MainLogin1() {
  ...
  return (
    <div className="h-screen w-full  bg-[#f2f3f5]">
      ...
      <form>
        <div className="h-full w-full my-[28px] px-[21px]">
          <div className="mb-8">
            <div className="flex  mb-[12px]">
              ...
              <span className="w-fit h-fit text-[#666666]">Phone number</span>
            </div>
            <div>
              <div className="w-full flex items-center gap-x-3  text-[#888888] p-1">
                <div className="w-1/3">
                  <select
                    className="h-full w-full px-[13px] py-[14px] text-base border-solid border-[rgb(136,136,136)] rounded-lg z-10"
                ...
                <div className="w-full z-10 p-1">
                  <input
                    ...
                    className="w-full bg-[rgb(255,255,255)] px-[13px] py-[14px] border-solid border-[rgb(136,136,136)] rounded-lg "
                    onChange={handlePhoneNumberChange}
                    value={phoneNumber}
                  />
                </div>
